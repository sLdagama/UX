          ...
          <div class="content-wrapper">
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8 p-0">
                        <h4 class="mb-1 mb-sm-0">Seja bem vindo <?php echo $_SESSION['nome_usuario']?>!</h4>  
                        <p class="mb-0 font-weight-normal d-none d-sm-block">Aqui você pode ver seus treinos!</p>
                      </div>
            ...
            <div class="row ">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Seus treinos</h4>
                      ...
                      <thead>
                        ...
                        <tbody>
                          <?php
                              ...
                              $sql = "select tbtreino.*, tbusuario.* from tbtreino
                              inner join tbusuario ON (tbusuario.codtreino = tbtreino.codtreino)
                              ...
                              if ($consulta == true) {
                                if($consulta->num_rows > 0) {
                                  while ($linha=$consulta->fetch_array(MYSQLI_ASSOC)) {
                                    ...
                                    echo '<td>
                                    <a href="pages/tables/treinousu.php?id='.$linha['codtreino'].'"><button type="button" class="btn btn-primary form-control">
                                      Exercícios
                                    </button></a>
                                    </td>';
                                    echo '<td>
                                    <a href="realizacao.php?id='.$_SESSION['codusu'].'"><button type="button" class="btn btn-primary form-control">
                                      Realização  
                                    </button></a>
                                    </td></tr>';
                                  }
