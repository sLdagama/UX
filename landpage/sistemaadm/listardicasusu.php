...
$id = $_GET['id'];
  $sql = "select nome_usuario, foto_usuario from tbusuario where codusu = '$id'";
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="principalu.php?id=<?php echo $id?>">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="listardicasusu.php?id=<?php echo $id?>">
              <span class="menu-icon">
        ...
        <div class="main-panel">
          ...
          <div class="row ">  
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Listagem de Dicas</h4>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <?php
                              ...
                              $sql = "select tbusuario.nome_usuario as nome_usuario, tbdicausu.dica as dica from tbdicausu
                                      inner join tbusuario on(tbusuario.codusu = tbdicausu.codusu) where tbdicausu.codusu = '$id'";
