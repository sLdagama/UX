            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="../testes/caddica.php"  method="POST" enctype="multipart/form-data">
                      
                    <div class="form-group">
                        
                        <input type="hidden" class="form-control" value="<?php echo $_GET['id']?>" id="id" name="id" readonly>
                      </div>
                    <div class="form-group">
                        <label for="exampleInputEmail3">Dica (opcional)</label>
                        <textarea class="form-control" placeholder="Coloque alguma dica se houver" id="dica" name="dica"></textarea>
                      </div>
                      <button type="submit" class="btn btn-primary mr-2">Cadastre!</button>
                      <a href="listardicas.php?id=<?php echo $_GET['id']?>"><button type="button" class="btn btn-primary mr-2">Listar dicas</button></a>
