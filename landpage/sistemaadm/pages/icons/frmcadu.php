            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="../testes/cadastrou.php" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="Insira o Email do usuário">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Senha</label>
                        <input type="password" class="form-control" id="senha" name="senha" placeholder="Insira a senha do usuário">
                      </div>
                      <div class="form-group">
                        <label for="">Telefone</label>
                        <input type="text" data-mask="(00) 0000-0000" class="form-control" id="telefone" name="telefone" placeholder="(xx) xxxx-xxxx">
                      </div>
                      <div class="form-group">
                        <label>Foto</label>
