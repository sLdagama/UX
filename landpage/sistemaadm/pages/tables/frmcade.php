          ...
          <div class="content-wrapper">
                       ...
                       if(isset($_GET['cad'])){
                        if($_GET['cad']=='erro'){
                         echo    '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                               <strong>Atenção!</strong> Houve algum erro no cadastro!
                               <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                               <span aria-hidden="true">&times;</span>
                               </button>
                             </div>';  
            ...
            <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="../testes/cadastroe.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="hidden" class="form-control" id="codtreino" name="codtreino" placeholder="Insira o nome do exercício" value="<?php echo $id?>" readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Nome do Exercício</label>
                        <input type="text" class="form-control" id="exercicio" name="exercicio" placeholder="Insira o nome do exercício">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">Descrição</label>
                        <input type="text" class="form-control" id="descricao" name="descricao" placeholder="Insira a descrição do treino">
                      </div>
                      <div class="form-group">
                        <label for="">Quantidade de séries</label>
                        <input type="number" class="form-control" id="qtdrep" name="qtdrep" placeholder="Insira a quantidade de séries.">
                      </div>
                      <div class="form-group">
                        <label>Imagem do exercício</label>
                        <input type="file" name="imgexercicio" class="file-upload-default">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="intervalo" name="intervalo" placeholder="intervalo entre cada série.">
                      </div>
                      <div class="form-group">
                        <label for="">Execuções por série</label>
                        <input type="number" class="form-control" id="execucao" name="execucao" placeholder="Insira a quantidade de execuções por repetição">
                      </div>
