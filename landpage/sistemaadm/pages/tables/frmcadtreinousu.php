        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Cadastro de treino ao usuário : <?php echo $_GET['id']?></h4>
                    <p class="card-description"> Sempre confira as informações!</p>
                    <p class="card-description"> Caso não tenha seu treino desejado, cadastre outro apertando <a href="frmcadtreino.php">Aqui!</a></p>
                    <form class="forms-sample" action="../testes/cadastrotusu.php" method="POST" enctype="multipart/form-data">
