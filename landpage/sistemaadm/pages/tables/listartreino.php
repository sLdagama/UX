        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Treinos</h3>
              <?php
  										   if(isset($_GET['dica'])){
											   if($_GET['dica']=='ok'){
            ...
            <div class="row ">  
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Listagem de treino</h4>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <?php
                              ...
                              $sql = "select * from realizacao_treino where codusu = '$id'";
                              $sql2 = "select tbusuario.*, tbtreino.* from tbtreino inner join tbusuario on (tbtreino.codtreino = tbusuario.codtreino) where tbusuario.codusu = '$id'"; 
